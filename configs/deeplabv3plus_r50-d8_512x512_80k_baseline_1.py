...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='CustomDataset',
            data_root='dataset/kaggle_original',
            pipeline=train_pipeline,
            split=None,
            img_dir='img',
            ann_dir='mask',
...
workflow = [('train', 1)] # 이렇게 바꾸면 val_loss가 뜨나?
...
log_config = dict(interval=50, hooks=[dict(type='TextLoggerHook'),
                                      dict(type='WandbLoggerHook',
                                           init_kwargs=dict(project='data_augmentation_x4', name='baseline_1'))])
work_dir = './work_dirs/baseline_1'