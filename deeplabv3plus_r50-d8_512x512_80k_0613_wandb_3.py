...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='CustomDataset',
            data_root='dataset/kaggle+bigeye_3',
            pipeline=train_pipeline,
            split=None,
            img_dir='img',
            ann_dir='mask',
...
log_config = dict(interval=50, hooks=[dict(type='TextLoggerHook'),
                                      dict(type='WandbLoggerHook',
                                           init_kwargs=dict(project='mmsegmentation', name='deeplabv3plus_wandb_3'))])
work_dir = './work_dirs/deeplabv3plus_0613_wandb_3'